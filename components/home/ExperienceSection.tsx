...
export function ExperienceSection() {
  return (
    <section className="relative overflow-hidden py-24 sm:py-32">
      <Container>
        <div className="glass-surface grid gap-10 p-6 sm:p-10 lg:grid-cols-[1.2fr_.8fr] lg:items-center">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#C6A66B]">Fragrance Consultation</p>
            <h2 className="mt-5 font-serif text-5xl leading-tight text-[#F3EEE5] sm:text-7xl">Not sure which fragrance suits you?</h2>
